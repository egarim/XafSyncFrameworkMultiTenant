...
using XafMT2.Module.BusinessObjects;
using Microsoft.Extensions.DependencyInjection;

namespace XafMT2.Module.DatabaseUpdate;
...
public class Updater : ModuleUpdater {
...
#if !RELEASE
        if (TenantName == null) {
            _ = CreateTenant("company1.com", "Company1","Node1");
            _ = CreateTenant("company2.com", "company2","Node2");
    ...
    private Tenant CreateTenant(string tenantName, string databaseName,string Node) {


        string connectionString =
                "XpoProvider=SyncDataStore;" +
                $"DataConnectionString='Integrated Security=SSPI;Pooling=false;Data Source=(localdb)\\mssqllocaldb;Initial Catalog={databaseName}_Data';" +
                $"DeltaConnectionString='Integrated Security=SSPI;Pooling=false;Data Source=(localdb)\\mssqllocaldb;Initial Catalog={databaseName}_Delta';" +
                "EnableDeltaTracking='true';" +
                "ExcludedEntities='';" +
                $"Identity=XafApp_{tenantName};" +
                $"ServerNodeId='{Node}';" +
